...
Магарето и Шрек тръгват на приключение в София, обаче Магарето било гладно… Тръгнали на път към най-хубавите дюнери, като пътешком спечелили раздаване на билети за концерт. 
Въпреки все още неизвестните позиция и време на този спиращ дъха спектакъл, те са убедени, че сцената е много голяма. Явно никога не са били в България и за това са сигурни,
че цялата сцена ще бъде построена без да има безследно изчезнали части, но все пак те имат цял екип за построяването ѝ, преди пристигането си на позиция Х.
...
осветителните тела. Магарето и Шрек моментално били уведомени за този инцидент. 
Те проучили за подходящи специалисти в България и открили, че в ИС има студенти, които могат да помогнат. 
Като за начало, студентите трябвало да сезапознаят как работи DMX 512, но опростен вариант на системата, защото нямат много време до концерта.
 
 Представете си лента дълга 512 разделения. Всяко разделение се нарича канал. 
 През тези канали преминава информация за осветителното тяло на сцената. 
 Примерно в каква посока да се завърти някой прожектор и/или с какъв цвят светлина да свети. 
 Понеже прожекторите са сложна техника, не могат да се управляват само през един канал и за това им трябват няколко последователни канала. 
 В зависимост от модела на осветителното тяло те може да са различен брой. За да работи системата за управление трябва да се определи на кои канали да се сложат различните прожектори. 
 Те може да са примерно: един на канали [1:10] и втори на - [11:20]. Така системата знае, без объркване, на кой канал да подаде сигнал който да се достави правилно до прожектора. 
 Такива канали ще са в състояние - good.
